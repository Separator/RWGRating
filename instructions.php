		...
		<div class="content clearfix b_radius">
			...
			<div class="content_panel b_radius">
				...
				<div class="centric">
					...
					<br />
					Рисунок 1.2. Окно программы RWGSP
				</div>
				...
				<div class="centric">
					...
					<br />
					Рисунок 1.3. Диалоговое окно выбора файла
				</div>
				...
				<div class="centric">
					...
					<br />
					Рисунок 1.4. Окно программы RWGSP с выбранным файлом статистики
				</div>
				...
				<div class="centric">
					...
					<br />
					Рисунок 1.5. Сохранение xml-файла статистики
				</div>
